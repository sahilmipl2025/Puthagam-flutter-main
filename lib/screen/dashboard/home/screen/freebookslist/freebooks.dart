...
import 'freebooks_list_controller.dart';

class FreeBooksListScreen extends StatelessWidget {
FreeBooksListScreen({Key? key}) : super(key: key);
  final FreeBooksController con = Get.put(FreeBooksController());
                        ...
                        homcon.freebooks.isEmpty
                            ...
                            : Flexible(
                                child: ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: homcon.freebooks.length,
                                    scrollDirection: Axis.vertical,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      return Obx(() => BookTile(
                                            isPaid: homcon.freebooks[index].isPaid,
                                            isPremium: homcon.freebooks[index].isPremium,
                                            title:
                                              homcon.freebooks[index].title ?? "",
                                            imageUrl:
                                                homcon.freebooks[index].image ?? "",
                                            authorName: homcon.freebooks[index]
                                                    .authorName ??
                                                "",
                                            totalListen: homcon
                                                .freebooks[index].listenCount
                                                .toString(),
                                            saveCount:homcon
                                                .freebooks[index].saveCount
                                                .toString(),
                                            rating: int.parse(homcon
                                                .freebooks[index].rating!
                                                .round()
                                                .toString()),
                                            caption:
                                               homcon
                                                .freebooks[index].caption ??
                                                    "",
                                            categoryName: homcon
                                                .freebooks[index]
                                                    .categoryName ??
                                            ...
                                            savedOnTap: () {
                                              ...
                                              if (homcon
                                                .freebooks[index].isSaved!
                                                  .value) {
                                                homcon.deleteSavedBookApi(
                                                  index: index,
                                                  bookId:
                                                      homcon
                                                .freebooks[index].id,
