...
class WeekPodcastScreen extends StatelessWidget {
  WeekPodcastScreen({Key? key}) : super(key: key);

  final WeekPodcastController con = Get.put(WeekPodcastController());
